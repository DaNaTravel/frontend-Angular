...
export class Favorite {
  ...
  {  
    ...
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/favorites?category=itinerary&page=${this.diem}&take=6`)
    .then((response) => {
    ...
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/favorites?category=location&page=${this.diem1}&take=12`)
    .then((response) => {
  ...
  navigation1(typ:any,i: any) {
    ...
    document
      .querySelectorAll('.total-navigation_button1')
      [i].classList.add('choice1');
    this.diem1= typ;
    this.inn=i
