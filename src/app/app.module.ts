...
@NgModule({
  ...
  imports: [AgmDirectionModule,GooglePlaceModule,DragDropModule,BrowserModule,CommonModule, AppRoutingModule, FormsModule, HttpClientModule,NgApexchartsModule,AgmCoreModule.forRoot({
