...
export class Total {
  ...
  ngOnInit(): void {
    ...
    instance
      .get(
        `http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations?page=${this.diem}&take=16`
      )
      .then((response) => {
    ...
    instance
      .get(
        'http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/favorites?category=location&take=100'
      )
      .then((response) => {
  ...
  search(value: any) {
    ...
    if (value.keyword == null) {
      instance
        .get(
          `http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations?page=1&take=16`
        )
        .then((response) => {
          this.locations = response.data.listLocations;
          this.loading=true
      ...
      instance
        .get(
          `http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations?keyword=${value.keyword}&page=1&take=16`
        )
        .then((response) => {
          this.locations = response.data.listLocations;
          this.loading=true
  ...
  change(value: any) {
    ...
    instance
      .get(
        `http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations?keyword=${value.target.value}&page=1&take=16`
      )
      .then((response) => {
        this.locations = response.data.listLocations;
        this.loading=true
  ...
  loc(value: any) {
    ...
    instance
      .get(
        `http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations?page=1&take=16&types=${value}`
      )
      .then((response) => {
        this.loading=true
        this.locations = response.data.listLocations;
  ...
  love(i: any) {
    ...
    instance
      .post(
        'http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/favorites/',
        this.ad
      )
      .then((response) => {
