...
export class Information {
  ...
  ngOnInit() {
    ...
    setTimeout(() => this.loading=true,800)
      ...
      instance
      .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations/${this.booking._id}`)
      .then((response) => {
  ...
  {  
    ...
    detail(value: any) {
      ...
      this.booking=value
      instance
      .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/locations/${value._id}`)
      .then((response) => {
        this.loading=true
        this.relateds=response.data.data.relatedLocations
        console.log(this.relateds)
