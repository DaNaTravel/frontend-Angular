...
export class TotalIti {
  ...
  ngOnInit() { 
    instance.get(
        'http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?isPublic=true&&page=1&take=20'
      )
      .then((response) => {
  ...
  {  
    ...
    navigation(value:any,i: any) {
      ...
      instance
      .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?isPublic=true&page=${this.diem}&take=20`,
      )
      .then((response) => {
        this.historys=response.data.data.output
...
choice1()
  ...
  choice4(day:any)
  {
    ...
    this.color5=false
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?isPublic=true&days=${day}`,
    )
    .then((response) => {
      this.historys=response.data.data.output
      console.log(response.data)   
  ...
  choice5(people:any)
  {
    ...
    this.color4=false
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?isPublic=true&people=${people}`,
    )
    .then((response) => {
      this.historys=response.data.data.output
      this.loading=true
