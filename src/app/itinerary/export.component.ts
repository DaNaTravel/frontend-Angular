...
export class Export {
  ...
  ngOnInit() {
    ...
    instance
    .get('http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&page=1&take=16',
    )
    .then((response) => {
    ...
    instance
    .get('http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&&isPublic=true'
...
console.log(this.thich)
 ...
 choice1()
  ...
  choice3()
  {
    ...
    this.color4=false
    this.color5=false
    this.name='private itinerary'
    instance
    .get('http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&&isPublic=false',
    )
    .then((response) => {
      this.loading=true
      this.historys=response.data.data.output
  ...
  choice4(value:any)
  {
    ...
    this.name='private itinerary'
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&&days=${value}`,
    )
    .then((response) => {
      this.loading=true
      this.historys=response.data.data.output
  ...
  choice5(value:any)
  {
    ...
    this.name='private itinerary'
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&&people=${value}`,
    )
    .then((response) => {
      this.loading=true
      this.historys=response.data.data.output
  ...
  public(value:any)
  {
    ...
    if(confirm(`Do you want to public this route ?`) == true){
      instance
    .patch(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes/${value}`,
    {
      "isPublic": true
    }
    )
  ...
  if(confirm(`Do you want to non-public this route ?`) == true){
    instance
     .patch(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes/${i}`,
     {
      "isPublic": false
    }
     )
   ...
   navigation(value:any,i: any) {
    ...
    instance
    .get(`http://ec2-13-114-139-244.ap-northeast-1.compute.amazonaws.com:5000/routes?access=private&page=${this.diem}&take=16`,
    )
    .then((response) => {
      this.loading=true
      this.historys=response.data.data.output
